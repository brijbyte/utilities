          ...
          return (
            <Tooltip.Root key={p.id}>
              ...
              >
                ...
                <span
                  className={`text-center leading-tight transition-colors ${compact ? "max-w-20 truncate text-[0.625rem]" : "max-w-20 text-xs font-medium wrap-break-word"} ${active ? "text-accent" : "text-text-muted group-hover:text-text"}`}
                >
                  {p.name}
                </span>
              </Tooltip.Trigger>
