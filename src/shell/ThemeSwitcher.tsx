...
export function ThemeSwitcher() {
  ...
  return (
    <Menu.Root>
      <Menu.Trigger className="w-8 h-8 flex items-center justify-center border border-border bg-bg-surface hover:bg-bg-hover cursor-pointer text-text-muted hover:text-text transition-colors">
        {current.icon}
      </Menu.Trigger>
      <Menu.Portal>
