  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div
          className="max-w-[42rem] mx-auto px-6 pt-10 pb-16"
          itemScope
          itemType="https://schema.org/Blog"
        >
          <h1 className="text-2xl font-bold mb-1" itemProp="name">
            blog
          </h1>
          <p className="text-xs text-text-muted mb-10" itemProp="description">
            updates, tips, and deep dives into browser-based developer tools
          </p>
          <meta itemProp="author" content="brijbyte" />
          {articles.length === 0 ? (
            ...
            <div className="flex flex-col gap-6">
              {articles.map((a) => (
                ...
                >
                  ...
                  {a.description && (
                    <p
                      className="text-xs text-text-muted mb-2 leading-relaxed"
                  ...
                  <div className="flex items-center gap-2 flex-wrap text-[0.6875rem] text-text-muted">
                    <time dateTime={a.date} itemProp="datePublished">
                      {formatDate(a.date)}
                    </time>
                    {a.tags.map((t) => (
                      <span
